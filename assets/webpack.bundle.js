...
store.dispatch((0, _actions.addWord)('imagination', 'воображение'));
store.dispatch((0, _actions.addWord)('promotion', 'повышение'));

//store.dispatch(deleteWord(0));
store.dispatch((0, _actions.editWord)(1, 'pedestrian', 'пешеход'));

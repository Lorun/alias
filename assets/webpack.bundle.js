...
var Board = function () {
	...
	_createClass(Board, [{
		...
		value: function getPointPosition(number) {
			var position = {};
			var turnPoint = 14;
...
var Team = function () {
	...
	_createClass(Team, [{
		key: "addOnBoard",
		value: function addOnBoard(position) {
...
console.log(new _board.Team('Kittens'));
...
var game = {
    ...
    onNext: function onNext(type) {}
};

var start = new _Subject.Subject();

var tick = _Observable.Observable.from(start);
tick.subscribe(game.startGame);

start.subscribe(function () {
    return console.log('Sub 1');
});
start.subscribe(function () {
    return console.log('Sub 2');
});
start.subscribe(function () {
    return console.log('Sub 5');
});
...
var Observable_1 = __webpack_require__(0);
var ScalarObservable_1 = __webpack_require__(7);
...
var ArrayLikeObservable_1 = __webpack_require__(20);
...
var FromObservable_1 = __webpack_require__(22);
